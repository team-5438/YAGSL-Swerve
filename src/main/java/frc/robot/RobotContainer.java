...
public class RobotContainer {
  ...
  public final XboxController driver = new XboxController(Constants.DriverConstants.id);
  ...
  private final AimShooter aimShooter = new AimShooter(shooterSubsystem, limelightSubsystem, operator, shootSpeed);
  ...
  private void configureBindings() {
    ...
    new JoystickButton(operator, PS4Controller.Button.kTouchpad.value).onTrue(new SequentialCommandGroup(
      new InstantCommand(() -> LEDSubsystem.sponsorStrip1.setData(LEDCommand.setStripColor(27, 0, 0, 255))),
      new WaitCommand(1),
      new InstantCommand(() -> LEDSubsystem.sponsorStrip1.setData(LEDCommand.setStripColor(27, 0, 0, 0)))
    ));
    new JoystickButton(operator, PS4Controller.Button.kPS.value).whileTrue(new IntakeCommandReverse(intakeSubsystem, shooterSubsystem));
  }
